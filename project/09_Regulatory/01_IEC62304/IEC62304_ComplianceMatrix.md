...
|-----------------|-------------|-----------------|--------|----------|
| **4.3** | Software Safety Classification | project/08_RiskManagement/03_SafetyClassification/ | Pending | Safety classification report |
| **5.1.1** | Software Development Plan | project/00_ProjectManagement/01_ProjectPlan/PMP.md | Pending | PMP |
...
| **5.1.4** | Software config management | project/00_ProjectManagement/04_ConfigurationManagement/CM_Plan.md | Pending | CM Plan |
| **5.1.5** | Documentation of deliverables | project/10_Documentation/DocumentIndex.md | Pending | Document Index |
| **5.2.1** | Define and document SW requirements | project/01_Requirements/03_SoftwareReqs/SRS.md | Pending | SRS |
...
| **5.2.4** | Re-evaluate medical device risk | project/08_RiskManagement/02_FMEA/ | Pending | FMEA |
...
| **5.3.1** | Transform requirements into architecture | project/02_Architecture/02_SoftwareArchitecture/ | Pending | SW-SAD |
...
| **5.4.1** | Detailed design (Class B/C) | project/03_Design/02_SoftwareDesign/SDD.md | Pending | SDD |
...
| **5.5.1** | Implement software units | src/ | Pending | Source code |
...
| **5.5.4** | Conduct unit verification | src/<component>/tests/ | Pending | Unit test results |
| **5.5.5** | Document unit verification | project/06_Verification/TestReport.md | Pending | Test reports |
| **5.6.1** | Integrate software units | project/05_Integration/01_SoftwareIntegration/ | Pending | Integration plan |
| **5.6.2** | Integration testing | project/06_Verification/02_IntegrationTests/ | Pending | Integration test results |
...
| **5.7.1** | SW system testing | project/06_Verification/03_SystemTests/ | Pending | System test results |
...
| **5.8.3** | Archive software | project/99_Archive/ | Pending | Archive |
...
| **6.1** | Maintenance plan | project/00_ProjectManagement/01_ProjectPlan/ | Pending | Maintenance section |
...
| **7** | Risk management integration | project/08_RiskManagement/ | Pending | Risk management file |
| **8** | Configuration management | project/00_ProjectManagement/04_ConfigurationManagement/ | Pending | CM Plan + logs |
